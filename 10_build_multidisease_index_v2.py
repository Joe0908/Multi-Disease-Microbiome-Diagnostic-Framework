...
def parse_args():
    parser = argparse.ArgumentParser(description="Build multi-disease microbiome index v2")
    ...
    parser.add_argument("--outdir", default="outputs_multidisease_index_v2")
...
def main():
    ...
    panel_path = outdir / "index_taxa_panel_v2.tsv"
    long_path = outdir / "multidisease_index_scores_long_v2.tsv"
    wide_path = outdir / "multidisease_index_scores_wide_v2.tsv"
    perf_path = outdir / "multidisease_index_performance_summary_v2.tsv"
    ...
    print("\nTop disease index separations (v2):")
